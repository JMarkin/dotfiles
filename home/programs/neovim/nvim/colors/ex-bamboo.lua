...
vim.api.nvim_set_hl(0,"@string.special.url",{cterm = {italic = true,underline = true},fg = 7389886,italic = true,underline = true})
...
vim.api.nvim_set_hl(0,"BlinkCmpGhostText",{bg = 2434595,cterm = {italic = true,nocombine = true},fg = 8619905,italic = true,nocombine = true})
...
vim.api.nvim_set_hl(0,"BlinkCmpLabelDeprecated",{cterm = {strikethrough = true},fg = 8619905,strikethrough = true})
...
vim.api.nvim_set_hl(0,"MiniStatuslineModeCommand",{bg = 14399057,bold = true,cterm = {bold = true},fg = 2434595})
...
vim.api.nvim_set_hl(0,"MiniStatuslineModeReplace",{bg = 15161980,bold = true,cterm = {bold = true},fg = 2434595})
vim.api.nvim_set_hl(0,"MiniStatuslineModeVisual",{bg = 11184895,bold = true,cterm = {bold = true},fg = 2434595})
