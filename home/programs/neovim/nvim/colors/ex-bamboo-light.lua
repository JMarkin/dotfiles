...
vim.api.nvim_set_hl(0,"@string.special.url",{cterm = {italic = true,underline = true},fg = 1608350,italic = true,underline = true})
...
vim.api.nvim_set_hl(0,"BlinkCmpGhostText",{bg = 16448224,cterm = {italic = true,nocombine = true},fg = 8619905,italic = true,nocombine = true})
