 ...
 */
static char *font = "JetBrainsMonoNL Nerd Font Mono:pixelsize=13:antialias=true:autohint=true";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = { "JetBrainsMonoNL Nerd Font Mono:pixelsize=13:antialias=true:autohint=true" };
#endif // FONT2_PATCH
